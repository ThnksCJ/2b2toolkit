...
public class RoundedUtil {
    ...
    private static final ShaderUtil roundedGradientShader = new ShaderUtil("shaders/roundedrectgradient.frag");
    public static ShaderUtil roundedShader = new ShaderUtil("shaders/roundedrect.frag");
