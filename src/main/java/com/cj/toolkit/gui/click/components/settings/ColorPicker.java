...
import com.cj.toolkit.setting.settings.ColorSetting;
import com.cj.toolkit.util.misc.ColorUtil;
import com.cj.toolkit.util.render.RenderUtil;
...
public class ColorPicker extends com.cj.toolkit.gui.click.components.Component {
    ...
    public ColorPicker(ColorSetting setting, com.cj.toolkit.gui.click.components.Button button, int n) {
